...
unsigned long moldCycleCounter;
...
void saveCounter(long int cnt)
{
  /*
    EEPROM.write(1, (cnt>>32)&255);
    EEPROM.write(2, (cnt>>24)&255);
    EEPROM.write(3, (cnt>>16)&255);
    EEPROM.write(4, (cnt>>8)&255);
    EEPROM.write(5, (cnt<<0)&255);
    EEPROM.commit();
  */
}
unsigned long readCounter()
{
  unsigned long l;
  /*
    byte b1=EEPROM.read(5);
    byte b2=EEPROM.read(4);
    byte b3=EEPROM.read(3);
    byte b4=EEPROM.read(2);
    byte b5=EEPROM.read(1);
    b1=0;b2=0;b3=0;b4=0;b5=0;
    l=(unsigned long)(b5)+((unsigned long)(b4)<<8)+((unsigned long)(b3)<<16)+((unsigned long)(b2)<<24)+((unsigned long)(b1)<<32);
    return l;
  */
  return 0;
}
...
//    delay(50);
  ...
  */
  //delay(100);
  int buttonStatus = digitalRead(23);
  /*
    if (buttonStatus == 1)
    {
